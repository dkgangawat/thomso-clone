  ...
  return (
    ...
    <header id="header">
      <div className="container">
        <a href="#">
          <img src="https://thomso.in/static/media/Group_37293.889a5e6cda2046f56c01ac186aca97fd.svg" alt="logo" />
        </a>
        <div className="right">
           <ul id="menuUl" className="">
          <li><a  href="http://thomso.in">Home</a> </li>
          <li><a  href="#" style={{color:"#21827e"}}>Event</a> </li>
          <li><a  href="http://thomso.in/heighlights">Highlights</a></li>
          <li><a  href="http://thomso.in/sponsors">Sponsors</a></li>
          <li><a  href="http://thomso.in/team">Team</a></li>
          <li><a  href="http://thomso.in/mun">MUN</a></li>
          <li><a  href="https://ca.thomso.in/">CA portal</a></li>
          <li><a  href="https://thomso.in/zonals">Zonals</a></li>
          <li><a  href="https://thomso.in/faqs">FAQs</a></li>
        <li><a className="login-btn" href="https://thomso.in/login">Login</a></li>
        </ul>
        </div>
